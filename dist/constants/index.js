...
export const getDownloadUrl = (symbolName, type, symbolNameWithParams) => `https://raw.githubusercontent.com/google/material-design-icons/master/symbols/web/${symbolName}/materialsymbols${type}/${symbolNameWithParams}.svg`;
